          ...
          <div className="rounded-3xl border border-white/20 bg-white/80 p-8 shadow-2xl backdrop-blur-lg">
            <div className="flex flex-col items-center space-y-6 md:flex-row md:space-y-0 md:space-x-8">
              ...
              <div className="relative">
                <div className="h-24 w-24 rounded-3xl bg-gradient-to-br from-blue-100 to-indigo-100 p-4 shadow-lg">
                  <img
                    src={profileIcon}
            ...
            <form onSubmit={handleSaveProfile} className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-xl border border-purple-200 bg-gradient-to-r from-purple-50 to-purple-100 px-4 py-3">
              ...
              <div className="space-y-2">
                ...
                {isEditingProfile ? (
                  <textarea
                    className="h-24 w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 transition-all duration-300 outline-none focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500/20"
                    value={profileData.address}
                    onChange={(e) =>
                      handleProfileInputChange("address", e.target.value)
                    }
                    required
                    placeholder="Your complete address for pickup and delivery"
                  />
                ) : (
                  <div className="min-h-[6rem] rounded-xl border border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100 px-4 py-3">
                    <span className="font-medium text-gray-900">
                      {profileData.address}
                    </span>
                  </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700">
                    ...
                    your order history and personal data will be removed.
                  </p>
                </div>
              </div>
            </div>
